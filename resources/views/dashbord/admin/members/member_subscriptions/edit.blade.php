            ...
            <form id="save_form" method="post"
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-md-2  mb-5">
                            <label
                                class="required fs-6 fw-semibold mb-2">{{trans('members.free_days')}}</label>
                    ...
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-md-4  mb-5">
                            <label
                                ...
                                (<span
                                    style="color: darkred" id="max_discount">{{$package_discount .'-'.trans('members.value').($package_discount/100)*$package_price}}</span>)</label>
                        ...
                        <input type="hidden" name="main_discount_hidden" id="main_discount_hidden" value="{{$package_discount}}">
                        <input type="hidden" name="main_discount_value_hidden" id="main_discount_value_hidden" value="{{($package_discount/100)*$package_price}}">
                                    ...
                                    <div class="form-group row mb-5">
                                        <div class="row" style="margin-top: 10px">
                                            ...
                                            <div class="col-md-1 mb-5">
                                                ...
                                                <input type="number" readonly class="form-control p-3 sub2cost " name="cost[]"
                                                       id="cost-{{$index}}" value="{{ $sub->price }}">

                                            </div>
                                            <div class="col-md-2  mb-5">
                                                <label class="required fs-6 fw-semibold mb-2">{{trans('members.sub_discount_type')}}</label>
                                                <select  class="form-control" onchange="change_sub_discount_type_1(this,{{$index}})" data-control="select2" name="sub_discount_type[]" id="sub_discount_type-{{$index}}">
                                                    <?php $pay_method_arr = [1 => trans('members.percentage'), 2 => trans('members.value')] ?>
                                                    @foreach($pay_method_arr as $key=>$value)
                                                        <option value="{{$key}}" {{ $key == $sub->discount_type ? 'selected' : '' }}> {{$value}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <input type="hidden" id="max_sub_dicount_edit_value" name="max_sub_dicount_edit_value" value="">
                                ...
                                <div data-repeater-item>
                                    <div class="form-group row mb-5">
                                        <div class="row" style="margin-top: 10px">
                                            ...
                                            <div class="col-md-1 mb-5">
                                                <label class="required fs-6 fw-semibold mb-2">{{trans('sub.duration')}}</label>
                                                <input type="number" readonly class="form-control " name="duration"
                                                       id="duration">
                                            ...
                                            <div class="col-md-1 mb-5">
                                                <label
                                                    class="required fs-6 fw-semibold mb-2">{{trans('members.cost')}}</label>
                                                <input type="number" readonly class="form-control p-3 sub2cost " name="cost" id="cost">
                                            ...
                                            <div class="col-md-3 mb-5">
                                                ...
                                                <input onkeyup="checkMaxDiscount(this);get_sub_cost(this)" class="form-control "
                                                       name="discount"
                                                       type="number" step="any"
                                                       value="" id="discount"/>
                                            </div>
        ...
        function get_sub_details2(index) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    let discountValue = (response.subscription.max_discount / 100) * response.subscription.price;
                    $('#max_discount-' + index).text(response.subscription.max_discount+ '% - {{trans('members.value')}}' + discountValue.toFixed(2));
                    //$('#sub_max_discount-' + index).text(response.subscription.max_discount);
                    $('#sub_price-' + index).text(response.subscription.price);
                },
                error: function (xhr, status, error) {
