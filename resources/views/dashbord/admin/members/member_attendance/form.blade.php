                        ...
                        @endif
                            <div class="row">
                                <div class="col-md-4  mb-5">
                                    ...
                                    <select class="form-control " onchange="get_subscription()" data-control="select2" name="member_id" id="member_id">
                                ...
                                <div class="col-md-4  mb-5">
                                    ...
                                    <input name="date" id="date" onchange="get_subscription()" type="date" class="form-control " value="{{old('date',date('Y-m-d'))}}">
                                </div>
