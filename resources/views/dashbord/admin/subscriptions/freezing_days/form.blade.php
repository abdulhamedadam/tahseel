    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                <div class="card-header"><h3 class="card-title">{{ trans('members.freezing_days') }}</h3></div>
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\subscription\freezing_day\StoreFreezingDayRequests', '#save_form'); !!}
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.current_subscriptions == null ) {
                        ...
                        if (data.current_subscriptions.main_subscriptions.max_freezing_days != data.freezing_days_count){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.subscriptions.delete_freezing_day', ['id' => '__id__']) }}".replace('__id__', freezingDayId),
                        type: 'POST',
                        headers: {
