                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach($sub_type_arr as $key => $value)
                                        <option
                                            value="{{ $key }}" {{ old('sub_type') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach($sub_type_arr as $key=>$value)
                                        <option
                                            value="{{$key}}" {{ old('customize_to') == $key ? 'selected' : '' }}>{{$value}}</option>
                                    @endforeach
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="max_freezing_days" id="max_freezing_days" value="{{old('max_freezing_days',0)}}"
                                       class="form-control mb-2" />
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12">
                                <label class="form-label required">{{trans('sub.details')}}(<span
                                        class="text-muted">{{trans('forms.lable_en')}}</span>)</label>
                                <textarea name="details_en" id="details_en" value="{{old('details_en')}}"
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12">
                                <label class="form-label required">{{trans('sub.details')}}(<span
                                        class="text-muted">{{trans('forms.lable_ar')}}</span>)</label>
                                <textarea name="details_ar" id="details_ar" value="{{old('details_ar')}}"
                                          class="form-control mb-2" rows="3"></textarea>
                            </div>
                        </div>
