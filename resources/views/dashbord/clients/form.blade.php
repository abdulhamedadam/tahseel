                    ...
                    <div class="col-md-12 row" style="margin-top: 10px"> --}}
                        ...
                        <div class="col-md-3" style="margin-top: 10px">
                            ...
                            <div class="input-group flex-nowrap ">
                                ...
                                <input type="date" class="form-control" name="subscription_date" id="subscription_date" value="{{ old('subscription_date') }}">
                            </div>
                        ...
                        <div class="col-md-3" style="margin-top: 10px">
                            ...
                            <div class="input-group flex-nowrap ">
                                ...
                                <select class="form-select" name="is_active" id="is_active">
                                    <option value="1" {{ old('is_active', 1) == 1 ? 'selected' : '' }}>{{ trans('clients.active') }}</option>
                                    <option value="0" {{ old('is_active', 1) == 0 ? 'selected' : '' }}>{{ trans('clients.inactive') }}</option>
                                </select>
                            </div>
