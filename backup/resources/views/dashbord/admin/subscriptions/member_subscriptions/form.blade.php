                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-md-4  mb-5">
                            ...
                            <select class="form-control " data-control="select2" name="member_id" id="member_id">
                        ...
                        <div class="col-md-3  mb-5">
                            ...
                            <select onchange="pay_type(this)" class="form-control form-control-solid pay-method-select"
                                                    ...
                                                    <div class="col-md-3  mb-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <input class="form-check-input" name="transportation"
                                                                type="checkbox" value="yes" id="flexSwitchDefault" />
