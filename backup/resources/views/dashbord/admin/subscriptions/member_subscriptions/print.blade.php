                                        ...
                                        <div class="col-xs-12 no-padding" style="margin-top: 2em;">
                                            <table id="bill" style="table-layout: fixed;margin-bottom: 0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{$one_data->main_subscriptions->price}}
                                                    ...
                                                    <td> {{((100-$one_data->discount)/100)*$one_data->main_subscriptions->price}}
                                                        ({{trans('members_subscription.price_lable')}})
                                                    </td>

                                                    @php

                                                        $total+=$one_data->main_subscriptions->price;
                                                        $final_total+=((100-$one_data->discount)/100)*$one_data->main_subscriptions->price;
                                                        $descount_total+=($one_data->discount/100)*$one_data->main_subscriptions->price;
                                                    @endphp
                                                ...
                                                @foreach($one_data->additional_subscriptions as $item)
                                                    <tr>
                                                        ...
                                                        <td> {{$item->end_date}}</td>
                                                        <td> {{$item->special_subscriptions->price}}
                                                            ({{trans('members_subscription.price_lable')}})
                                                        </td>
                                                        ...
                                                        @php
                                                            ...
                                                            $total+=$item->special_subscriptions->price;
                                                            $final_total+=((100-$item->discount)/100)*$item->special_subscriptions->price;
                                                            $descount_total+=($item->discount/100)*$item->special_subscriptions->price;
                                                        @endphp
                                                    </tr>
...
<script type="text/javascript">
    document.getElementById('final_total').innerText='{{$final_total}}';
    window.print();
