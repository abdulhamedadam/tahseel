    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                <li class="breadcrumb-item text-muted"><a href="{{ route('admin.dashboard') }}" class="text-muted text-hover-primary">{{trans('Toolbar.home')}}</a>
                </li>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="member_name"
                                       ...
                                       placeholder="{{trans('members.member_name')}}" value="{{old('member_name',$one_data->memberName)}}"/>
                                <!--end::Input-->
                                @error('member_name')
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="goal_id[]" id="goal_id" class="form-select form-select-solid is-valid"
                                    ...
                                    @foreach ($goals as $goal)
                                        <option value="{{ $goal->id }}" @if(in_array($goal->id, $one_data->memberGoal)) selected @endif>
                                            {{ $goal->title }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-10">
                                    ...
                                    <input  class="form-control form-control-solid @error('birth_date',$one_data->memberBirthDate) is-invalid @enderror"
                        ...
                        <div class="row" >
                            <div class="col-md-4">
                                ...
                                <input type="text" name="email"
                                       ...
                                       placeholder="{{trans('members.email')}}" value="{{old('email',$one_data->memberEmail)}}"/>
                                <!--end::Input-->
                                @error('email')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="phone" id="phone"
                                       ...
                                       placeholder="{{trans('members.phone')}}" value="{{old('phone',$one_data->phone_full)}}"/>
                                <!--end::Input-->
                                @error('phone')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="health_status_id" id="health_status_id" class="form-select form-select-solid is-valid"
                                        data-control="select2" data-placeholder="{{trans('members.select')}}"
                                        data-allow-clear="true" >
                                    <option></option>
                                    @foreach( $health_status as $item )
                                        <option value="{{$item->id}}" @if ($one_data->memberHealthStatus == old('health_status_id', $item->id)) selected @endif>{{$item->title}}</option>
                                    @endforeach
