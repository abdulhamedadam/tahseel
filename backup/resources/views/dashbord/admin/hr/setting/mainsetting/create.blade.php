                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <select class="form-select mb-2 @error('type_code') is-invalid @enderror"
                                    onchange="/*set_status()*/" data-control="select2" data-hide-search="false"
                                    data-dropdown-parent="#exampleModal" data-placeholder="Select an option"
                                    data-allow-clear="true" id="type_code" name="type_code">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="title_en" class="form-control mb-2" placeholder="title"
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="title_ar" class="form-control mb-2" placeholder="العنـــوان"
                                    value="" required autocomplete />
                            </div>
                            <div class="row">
                                ...
                                <select class="form-select mb-2 @error('status') is-invalid @enderror"
                                    onchange="/*set_status()*/" data-control="select2" data-hide-search="true"
                                    data-placeholder="Select an option" id="status" name="status">
                                    <?php
                                    $status_array = ['1' => 'Active', '0' => 'NotActive'];
                                    ?>
                                    <option value=" ">{{ trans('maindata.Select') }}</option>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('admin.hr.mainsetting.edit', $x->id) }}" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <!--begin::Select2-->
                                                <select class="form-select mb-2 @error('type_code') is-invalid @enderror"
                                                    onchange="/*set_status()*/" data-control="select2"
                                                    ...
                                                    @foreach ($type as $row)
                                                        <option value="{{ $row->code }}"
                                                            @if ($row->code == $x->type_code) {{ 'selected' }} @endif>
                                                            {{ $row->title }}</option>
                                                    @endforeach
                                                </select>
                                                <!--end::Select2-->
                                            ...
                                            <div class="row">
                                                <label class="required form-label">{{ trans('Hr_setting.Title') }}
                                                    (<span
                                                        class="text-gray-600">{{ trans('forms.lable_en') }}</span>)</label>

                                                <input type="text" name="title_en" class="form-control mb-2"
                                                    placeholder="Title" value="{{ $title['en'] }}" required
                                                    autocomplete />
                                            </div>
                                            <div class="row">
                                                <label class="required form-label">{{ trans('Hr_setting.Title') }}
                                                ...
                                                <input type="text" name="title_ar" class="form-control mb-2"
                                                    placeholder="العنــوان" value="{{ $title['ar'] }}" required
                                                    autocomplete />
                                            </div>
                                            <div class="row">
                                                ...
                                                <select class="form-select mb-2 @error('status') is-invalid @enderror"
                                                    ...
                                                    <?php
                                                    $status_array = ['0' => 'NotActive', '1' => 'Active'];
                                                    ?>
                                                    <option value=" ">{{ trans('maindata.Select') }}</option>
                                                    @foreach ($status_array as $key => $value)
                                                        <option value="{{ $key }}"
                                                            @if ($key == $x->status) {{ 'selected' }} @endif>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
