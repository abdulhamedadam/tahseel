...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.hr.employee.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
                        ...
                        <div class="row">
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="number" name="national_id"
                                       ...
                                       placeholder="Product name" value="{{old('national_id')}}"/>
                                <!--end::Input-->
                                @error('national_id')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="mb-10 col-4 ">
                                ...
                                <input type="text"
                                       ...
                                       placeholder="" name="date_hired" id="date_hired" value="{{old('date_hired')}}">
                                <!--end::Input-->
                                @error('date_hired')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="number" name="experience_year"
                                       ...
                                       placeholder="experience_year" value="{{old('experience_year')}}"/>
                                <!--end::Input-->
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="number" name="holiday_emergency"
                                       ...
                                       placeholder="holiday_emergency" value="{{old('holiday_emergency')}}"/>
                                <!--end::Input-->
                            ...
                            <div class="mb-10 col ">
                                ...
                                <input type="number"
                                       ...
                                       value="{{old('holiday_year')}}" name="holiday_year"
                        ...
                        <div class="row ">
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="number"
                                       ...
                                       value="{{old('main_salary')}}" name="main_salary"
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="email"
                                       ...
                                       placeholder="" name="work_hour_day" value="{{old('work_hour_day')}}">
                                <!--end::Input-->
                                @error('work_hour_day')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-10 col  fv-row">
                                ...
                                <input type="email"
                                       ...
                                       placeholder="" name="work_month_day" value="{{old('work_month_day')}}">
                                <!--end::Input-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\hr\employee\StoreRequest', '#StorForm') !!}
    <script>
