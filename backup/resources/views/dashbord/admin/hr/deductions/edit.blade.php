    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.hr.hr_deductions.index') }}"
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        <div class="row">
            ...
            <form id="StorForm" class="form d-flex flex-column flex-lg-row"
                  action="{{route('admin.hr.hr_deductions.update',$hr_deductions->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                <div class="mb-10 fv-row col">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('deductions.Employee_ID')}}
                                ...
                                <div class="mb-10 fv-row col">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('deductions.value')}}
...
<div class="row" >                     <!--end::Input group-->
                ...
                <div class="mb-10 fv-row col">
                    <!--begin::Label-->
                    <label
                        class="required fs-6 fw-semibold mb-2">{{trans('deductions.date_deductions')}}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input
                        class="form-control form-control-solid @error('date_deductions') is-invalid @enderror"
                      name="date_deductions" 
                    ...
                    @enderror
                            ...
                            <!--begin::Input group-->
                                ...
                                <div class="mb-10 fv-row col">
                                    <!--begin::Label-->
                                    <label class="form-label">{{trans('deductions.reason')}}
                                    </label>
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Hr\operation\DeductionsRequest', '#StorForm') !!}
