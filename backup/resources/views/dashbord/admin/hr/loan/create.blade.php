    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        <div class="row">
            ...
            <form id="StorForm" class="form d-flex flex-column flex-lg-row"
                  action="{{route('admin.hr.hr_loan.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <!--begin::Aside column-->
                  ...
                  <!--              <div class="card-header">
                                ...
                                <div class="mb-10 fv-row col">
                                    ...
                                    <select name="loan_type" id="loan_type"
                                            ...
                                            data-placeholder="{{trans('maindata.Select')}}">
                                            <?php
                                            $types = array('advance payment', 'loan') //this was the issue
                                            ?>
...
@section('js')
    ...
    <script>
       ...
       /* function set_type() {
           var loan_type = $('#kt_ecommerce_add_category_status');
            var type_val = $('#loan_type').val();
            if (type_val == 0) {
                type.removeClass('bg-success').addClass('bg-danger');
            } else if (type_val == 1) {
                loan_type.removeClass('bg-danger').addClass('bg-success');
            }
        } */
