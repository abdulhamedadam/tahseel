    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                ...
                <form id="StorForm" method="post" action="{{ route('admin.subscriptions.task_management.store') }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="title_en" id="title_en" class="form-control mb-2"
                                    placeholder="{{ trans('sub.title') }}" value="" required autocomplete />
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    name="type" id="type">
                                    <?php
                                    $select_array = ['Maintenance', 'Complaint', 'Tasks for employees', 'Reports', 'Requirements', 'Managers schedule'];
                                    ?>
                                    <option></option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date" id="date" class="form-control mb-2" value=""
                            ...
                            <div class="mb-10 fv-row col">
                                ...
                                <select name="emp_id" id="emp_id"
                                    class="form-select @error('emp_id') is-invalid @enderror" data-control="select2"
                                    data-allow-clear="true" data-placeholder="{{ trans('maindata.Select') }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    <?php
                                    $select_array = ['In Progress', 'Finished', 'Not Finished'];
                                    ?>
                                    <option></option>
                                    @foreach ($select_array as $key => $value)
                                        <option value="{{ $key }}">{{ $value }}</option>
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-12 col">
                                <label class="form-label required">{{ trans('sub.details') }}(<span
                                        class="text-muted">{{ trans('forms.lable_en') }}</span>)</label>
                                <textarea name="details_en" id="details_en" value="" class="form-control mb-2"></textarea>
                            </div>

                            <div class="col-md-12 col">
                                <label class="form-label required">{{ trans('sub.details') }}(<span
                                        class="text-muted">{{ trans('forms.lable_ar') }}</span>)</label>
                                <textarea name="details_ar" id="details_ar" value="" class="form-control mb-2"></textarea>
                            </div>
                        </div>
