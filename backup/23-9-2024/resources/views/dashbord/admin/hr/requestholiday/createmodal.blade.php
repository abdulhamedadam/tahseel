                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="emp_id" class="form-control mb-2" placeholder="ID"
                            ...
                            <div class="input-group" id="kt_td_picker_button" data-td-target-input="nearest"
                                data-td-target-toggle="nearest">
                                <input id="kt_td_picker_modal_input" type="text" class="form-control"
                                    data-td-target="#kt_td_picker_modal" />
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.dashboard') }}"
                                class="text-muted text-hover-primary">{{ trans('Hr_setting.Home') }}</a>
                        </li>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                        <label
                                                            class="required form-label">{{ trans('Hr_setting.Status') }}(<span
                                                                class="text-gray-600">{{ trans('forms.lable_en') }}</span>)</label>

                                                        <!--begin::Select2-->
                                                        <select
                                                            class="form-select mb-2 @error('status') is-invalid @enderror"
                                                    ...
                                                    <div class="row">
                                                        <label
                                                            class="required form-label">{{ trans('Hr_setting.Type') }}</label>
