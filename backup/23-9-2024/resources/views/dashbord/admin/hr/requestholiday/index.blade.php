...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.hr.reqholiday.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('reqholiday.Emp_ID')}}</th>
                        <th>{{trans('reqholiday.Num_Days')}}</th>
                        <th>{{trans('reqholiday.Start_Date')}}</th>
                        <th>{{trans('reqholiday.End_Date')}}</th>
                        <th>{{trans('reqholiday.Holiday_Type')}}</th>
                        <th>{{trans('reqholiday.Reason')}}</th>
                        <th>{{trans('reqholiday.Action')}}</th>
                    </tr>
                    </thead>
                </table>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.hr.reqholiday.index')}}",
                    columns: [
                        {data: 'emp_id', name: 'emp_id'},
                        {data: 'num_days', name: 'num_days'},
                        {data: 'date_start', name: 'date_start'},
                        {data: 'date_end', name: 'date_end'},
                        {data: 'typeholiday', name: 'typeholiday'},
