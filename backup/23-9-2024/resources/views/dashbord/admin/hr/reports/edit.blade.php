    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        <div class="row">
            ...
            <form id="StorForm" class="form d-flex flex-column flex-lg-row"
                  action="{{route('admin.hr.hr_reports.update',$hr_reports->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <!--begin::Aside column-->
     ...
     <div class="row">
                                <div class="mb-10 fv-row col">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('reports.Employee_ID')}}
                ...
                <div class="mb-10 fv-row col">
                    <!--begin::Label-->
                    <label
                        class="required fs-6 fw-semibold mb-2">{{trans('reports.date_report')}}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input
                        class="form-control form-control-solid @error('date_report') is-invalid @enderror"
                      name="date_report"
                        placeholder="Pick date rage" id="date_report"/>
                    <!--end::Input-->
                    @error('date_report')
                    <div
...
<div class="row"  >
                                <div class="mb-10 fv-row col">
                                    <!--begin::Label-->
                                    <label class="form-label">{{trans('reports.details')}}
                                    </label>
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Hr\operation\ReportsRequest', '#StorForm') !!}
