...
@section('content')
    <?php
    $status_array = ['notactive' => trans('main.notactive'), 'active' => trans('main.active')];
    ?>
    <!-- Modal 1-->
                        ...
                        @foreach ($holiday_setting as $x)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($x->status == 'active')
                                        <div class="badge badge-light-success fw-bold">{{ $status_array[$x->status] }}
                                        </div>
                                    @else
                                        <div class="badge badge-light-danger fw-bold">{{ $status_array[$x->status] }}
                                        </div>
                                    @endif
                                </td>
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" name="num_days" class="form-control mb-2"
                                                    min="1" placeholder="" value="{{ $x->num_days }}" required
                                                    autocomplete />
                                            </div>
                                            <div class="row">
                                                <label class="required form-label">Status</label>
                                                ...
                                                <select class="form-select mb-2 @error('status') is-invalid @enderror"
                                                    ...
                                                    @foreach ($status_array as $key => $value)
                                                        <option value="{{ $key }}"
                                                            @if ($x->status == $key) {{ 'selected' }} @endif>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
