...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.hr.hr_permission.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('permission.Emp_ID')}}</th>
                        <th>{{trans('permission.status')}}</th>
                        <th>{{trans('permission.start_permission')}}</th>
                        <th>{{trans('permission.end_permission')}}</th>
                        <th>{{trans('permission.date_permission')}}</th>
                        <th>{{trans('permission.period')}}</th>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.hr.hr_permission.index')}}",
                    columns: [
                        {data: 'emp_id', name: 'emp_id'},
                        {data: 'status', name: 'status'},
                        {data: 'start_permission', name: 'start_permission'},
                        {data: 'end_permission', name: 'end_permission'},
                        {data: 'date_permission', name: 'date_permission'},
