    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            @if(auth()->user()->hasRole('Super-Admin')||(auth()->user()->canAny(['list_user','list_roles'])))
                ...
                <?php  if (in_array(optional(explode('.', Route::currentRouteName()))[1], array('mdata', 'about', 'teacher'))) {
                    echo 'here show';
                } ?>

                <?php  if (in_array(optional(explode('.', Route::currentRouteName()))[2], array('holiday_type', 'mainsetting', 'typesetting', 'settings_data', 'devices', 'exercise_devices', 'task_management'))) {
                    echo 'here show';
                } ?>
                    ...
                    <span class="menu-link">
                        ...
                        <span
                            class="menu-title">{{trans('sidebar.setting')}}</span><span
                        ...
                        <div data-kt-menu-trigger="click"
                            ...
                            <!--begin:Menu link--><span
                                class="menu-link"><span class="menu-bullet"><span
                                    ...
                                    class="menu-title">{{trans('sidebar.site_setting')}}</span><span
                                    class="menu-arrow"></span></span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link"><span class="menu-bullet"><span
                                    class="bullet bullet-dot"></span></span><span
                                class="menu-title">{{trans('sidebar.subscriptionsDefined')}}</span><span
                                class="menu-arrow"></span></span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-accordion">
                        ...
                        <span class="menu-bullet">
                            ...
                            --}}{{--      <!--begin:Menu item-->
                                  <div class="menu-item">
                                      <!--begin:Menu link-->
                                      <a class="menu-link" href="/keen/demo1/apps/ecommerce/sales/listing.html"><span
                                  ...
                                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                                  href="/keen/demo1/apps/ecommerce/sales/details.html"><span
                                              class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                              class="menu-title">Order Details</span></a><!--end:Menu link--></div>
                                  <!--end:Menu item--><!--begin:Menu item-->
                                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                                  href="/keen/demo1/apps/ecommerce/sales/add-order.html"><span
                                              class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                              class="menu-title">Add Order</span></a><!--end:Menu link--></div>
                                  <!--end:Menu item--><!--begin:Menu item-->
                                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                                  href="/keen/demo1/apps/ecommerce/sales/edit-order.html"><span
                                              class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                    ...
                    <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click"
                             class="menu-item menu-accordion <?php  if (in_array(optional(explode('.', Route::currentRouteName()))[2], array('holiday_type', 'mainsetting', 'typesetting'))) {
                                 echo 'here show';
                             } ?>">
                            ...
                            <!--begin:Menu link--><span
                                class="menu-link"><span class="menu-bullet"><span
                                        class="bullet bullet-dot"></span></span><span
                                    class="menu-title">{{trans('sidebar.hr_Settings')}}</span><span
                                    class="menu-arrow"></span></span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                        ...
                        <div data-kt-menu-trigger="click"
                             ...
                             <?php  if (in_array(optional(explode('.', Route::currentRouteName()))[2], array('settings_data', 'devices', 'exercise_devices', 'task_management', 'special_subscriptions', 'main_subscriptions', 'offers'))) {
                                 echo 'here show';
                             } ?>">
                            <!--begin:Menu link-->
                            <span class="menu-link"><span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span></span><span
                                    class="menu-title">{{trans('sidebar.sub_settings')}}</span><span
                                    class="menu-arrow"></span></span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
...
--}}
                            ...
                            <!--begin:Menu item-->
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link
<?php  if (optional(explode('.', Route::currentRouteName()))[2] == 'devices') {
                                        echo 'active';
                                    } ?>"
                                       href="{{ route('admin.subscriptions.devices.index') }}">
         ...
         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion {{ (in_array(optional(explode('.', Route::currentRouteName()))[2], array('transportation','exercise_devices', 'task_management'))) ? 'show' : ''  }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                                <span class="menu-icon">
                                    ...
                                    <!--end::Svg Icon-->
											...
											<span class="menu-title">{{trans('sidebar.subscriptionsOprition')}}</span>
											<span class="menu-arrow"></span>
										</span>
                    <!--end:Menu link-->
                    ...
                    <!--begin:Menu sub site data-->
                    <div class="menu-sub menu-sub-accordion
                            {{ (in_array(optional(explode('.', Route::currentRouteName()))[2], array('transportation','exercise_devices', 'task_management'))) ? 'show' : ''  }}">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link <?php  if (optional(explode('.', Route::currentRouteName()))[2] == 'exercise_devices') {
                               ...
                               href="{{ route('admin.subscriptions.exercise_devices.index') }}">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link
<?php  if (optional(explode('.', Route::currentRouteName()))[2] == 'task_management') {
                                echo 'active';
                            } ?>" href="{{ route('admin.subscriptions.task_management.index') }}">
                ...
                <!--begin:Menu item-->
                    ...
                    <div data-kt-menu-trigger="click"
                         class="menu-item menu-accordion {{ (in_array(optional(explode('.', Route::currentRouteName()))[2], array('hr_reports','hr_deductions','hr_bonuses','hr_loan','hr_permission'))) ? 'show' : ''  }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                               <span class="menu-icon">
                                   <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/keenthemes/keen/docs/core/html/src/media/icons/duotune/general/gen055.svg-->
                        ...
                        <!--begin:Menu sub site data-->
                        <div class="menu-sub menu-sub-accordion
                           {{ (in_array(optional(explode('.', Route::currentRouteName()))[2], array('hr_reports','hr_deductions','hr_bonuses','hr_loan','hr_permission','reqholiday'))) ? 'show' : ''  }}">
