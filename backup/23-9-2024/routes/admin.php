...
Route::group(
    ...
    Route::group(['middleware' => ['auth:admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        Route::group(['prefix' => 'subscriptions', 'as' => 'subscriptions.'], function () {
            ...
            Route::resource('member-subscriptions', \App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class);
            Route::get('member-subscriptions/additional_subscriptions/{process_num}', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'additional_subscriptions'])->name('additional_subscription');
            Route::get('member-subscriptions/delete_addtional_subscription', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'delete_addtional_subscription'])->name('delete_addtional_subscription');

            Route::post('member-subscriptions/add_additional_subscriptions/{id}', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'add_additional_subscriptions'])->name('add_additional_subscriptions');
            Route::get('get_member_subscription_details', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'get_member_subscription_details'])->name('get_member_subscription_details2');

            Route::post('member-subscriptions/print', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'print'])->name('print_member_subscription');
            ...
            Route::get('exercise_devices/show_load/{id}', [DeviceExercises_C::class, 'show_load'])->name('exercise_devices.load_details');

            Route::resource('devices', \App\Http\Controllers\Admin\subscriptions\Devices_C::class);
            Route::get('devices/show_load/{id}', [Devices_C::class, 'show_load'])->name('devices.load_details');

            Route::resource('task_management', \App\Http\Controllers\Admin\subscriptions\TaskManagementController::class);
            Route::get('task_management/show_load/{id}', [TaskManagementController::class, 'show_load'])->name('task_management.load_details');
            ...
            Route::group(['prefix' => 'Reports', 'as' => 'Reports.'], function () {
                ...
                Route::resource('MembersAttendanceReports', App\Http\Controllers\Admin\Members\MembersReportsController::class);
                /*******************************************************************************/
                Route::get('MembersReports/ExpireMainSubscriptions',[App\Http\Controllers\Admin\Members\MembersReportsController::class,'expire_mainSubscription'])->name('expire_mainSubscription');
                Route::get('MembersReports/ExpireSpecialSubscriptions',[App\Http\Controllers\Admin\Members\MembersReportsController::class,'expire_specialSubscription'])->name('expire_specialSubscription');
            ...
            /**********************************************************/
            Route::get('get_memebr_subscription',[App\Http\Controllers\Admin\Members\MembersAttendanceController::class,'get_member_subscription'])->name('get_member_subscription');
            Route::resource('MembersAttendance', App\Http\Controllers\Admin\Members\MembersAttendanceController::class);
            Route::get('MembersAttendance/delete/{id}', [App\Http\Controllers\Admin\Members\MembersAttendanceController::class,'delete'])->name('delete_member_attendance');
            /***********************************************************/
...
//        Route::get('Members/delete/{id}', [MembersController::class, 'delete'])->name('Members.delete');
        ...
        Route::resource('Members-Inbody', \App\Http\Controllers\Admin\Members\InbodyController::class);

        Route::get('Members-Inbody/show', [\App\Http\Controllers\Admin\Members\InbodyController::class, 'show'])->name('inbody_show');
        ...
        /*******************************************************************/
        Route::get('get_trainer_details',[\App\Http\Controllers\Admin\Trainers\TrainersController::class,'get_trainer_details'])->name('get_trainer_details');

        Route::resource('schedule', \App\Http\Controllers\Admin\Trainers\ScheduleController::class);
        Route::get('schedule/show_load/{id}', [ScheduleController::class, 'show_load'])->name('schedule.load_details');
...
Route::group(
    ...
    Route::post('printQr/{id}', [\App\Http\Controllers\Admin\Members\MemberSubscriptionsController::class, 'printQr'])->name('printQr');
