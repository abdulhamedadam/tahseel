...
use App\Http\Requests\Site\Terms\StoreRequest;
use App\Http\Requests\Site\Terms\UpdateRequest;
...
class TermsController extends Controller
{
    ...
    public function index(Request $request)
    {
                   ...
                   <span class="svg-icon svg-icon-5 m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                             <a href="' . route('admin.terms.edit', $row->id) . '"
                               address="' . trans('forms.edite_btn') . '" class="menu-link px-3"
                               >' . trans('forms.edite_btn') . '</a>
                        </div>
                   		<!--<div class="menu-item px-3">
                                <a href="' . route('admin.terms.show', $row->id) . '"
                                           address="' . trans('forms.details') . '" class="menu-link px-3"
                                           >' . trans('forms.details') . '</a>
                        </div>-->
                        <div class="menu-item px-3">
                                <a href="javascript:void(0)" data-kt-table-details="details_row" data-url="' . route('admin.terms.load_details', $row->id) . '"
                                           address="' . trans('forms.details') . '" class="menu-link px-3"
                                         data-bs-toggle="modal" data-bs-target="#kt_modal_1"  >' . trans('forms.details') . '</a>
                        </div>
                        <div class="menu-item px-3">
                                <a href="' . route('admin.terms.destroy', $row->id) . '" data-kt-table-delete="delete_row"
        ...
        return view('dashbord.admin.Site.Terms.index');
    }
    ...
    {
        return view('dashbord.admin.Site.Terms.create');
...
//        dd($request->all());
        try {
            ...
            $inserted_data = SiteTerms::create($insert_data);
...
//            dd($insert_data);
    ...
    {
        $one_data = SiteTerms::findOrFail($id);
        $one_data = new TermsResource($one_data);
        $data['one_data'] = $this->prepare_data($one_data);
//        dd($data);
        return view('dashbord.admin.Site.Terms.details', $data);
    }
...
//        dd($data);
        return view('dashbord.admin.Site.Terms.load_details', $data);
    }
...
//        dd($data);
        return view('dashbord.admin.Site.Terms.edit', $data);
    ...
    public function update(UpdateRequest $request, $id)
    {
        //        dd($request->all());
        try {
            $data = SiteTerms::find($request->id);
